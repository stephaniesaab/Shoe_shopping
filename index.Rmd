...
shoes3 %>%
  ggplot(mapping=aes(x=price_avg,fill=prices_issale))+
  geom_histogram(bins=30,position="dodge")+
  facet_wrap(~gender)+
  
  labs(title="The shoe shopping tendencies of 10,000 men and 10,000 women from 2014 to 2017",subtitle="Women pay more for their shoes while men look for sales more")
```
